...
<div style="max-width:820px;margin:2rem auto;padding:0 1.5rem 3rem;">
  ...
  <div class="no-print" style="display:flex;gap:.75rem;justify-content:center;margin-top:1.5rem;flex-wrap:wrap;">
    <button onclick="printDoc()" style="display:inline-flex;align-items:center;gap:.5rem;background:#2563eb;color:#fff;font-weight:600;padding:.75rem 1.75rem;border-radius:.625rem;border:none;cursor:pointer;font-size:.9rem;">
