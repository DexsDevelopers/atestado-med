  ...
  <div style="position:relative;z-index:1;">
    ...
    <div style="display:flex;flex-wrap:wrap;justify-content:center;gap:.75rem;margin-top:2rem;">
      ...
      $badges = [
        ...
        ['icon'=>'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'label'=>'Código de Ética CFM'],
      ];
      foreach ($badges as $b): ?>
      <div style="display:inline-flex;align-items:center;gap:.4rem;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.2);border-radius:999px;padding:.35rem .9rem;backdrop-filter:blur(8px);">
...
<section style="background:#fff;padding:3.5rem 1.5rem;">
  <div style="max-width:760px;margin:0 auto;text-align:center;">
    <p style="font-size:.75rem;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#2563eb;margin-bottom:.5rem;">Como funciona</p>
    <h2 style="font-size:1.5rem;font-weight:800;color:#111827;margin-bottom:2.5rem;">Verificação em 3 passos simples</h2>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:2rem;">
      <?php
      $steps = [
        ['n'=>'1','title'=>'Escaneie o QR Code','desc'=>'Use a câmera do celular para escanear o QR Code impresso no documento médico.','icon'=>'M3 4h4v4H3zM3 10h4v4H3zM10 3h4v4h-4zM17 3h4v4h-4zM17 10h4v4h-4zM10 17h4v4h-4zM17 17h4v4h-4zM3 17h4v4H3zM10 10h4v4h-4z'],
        ['n'=>'2','title'=>'Ou insira o código','desc'=>'Digite manualmente o código único de 18 caracteres presente no rodapé do documento.','icon'=>'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4'],
        ['n'=>'3','title'=>'Resultado instantâneo','desc'=>'Veja se o documento é autêntico, os dados do paciente, médico e o atestado em PDF.','icon'=>'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'],
      ];
      foreach ($steps as $s): ?>
      <div style="display:flex;flex-direction:column;align-items:center;gap:.75rem;">
        <div style="width:48px;height:48px;background:linear-gradient(135deg,#2563eb,#1e3a6e);border-radius:50%;display:flex;align-items:center;justify-content:center;">
        ...
        <div style="font-size:.6875rem;font-weight:700;background:#eff6ff;color:#2563eb;border-radius:999px;padding:.15rem .6rem;">PASSO <?= $s['n'] ?></div>
        <div style="font-size:.9375rem;font-weight:700;color:#111827;"><?= $s['title'] ?></div>
...
<!-- LEGAL NOTICE -->
<section style="background:#f8faff;padding:2rem 1.5rem;border-top:1px solid #e0e7ff;">
